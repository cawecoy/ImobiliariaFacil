...
<html>
    <head>
        ...
        <title>Pesquisar - Editar / Visualizar Corretores</title>
    ...
    <body>
        ...
        <form method="POST" action="VisualizarEditarCorretor.jsp">
            <table class="tabela">
                <thead>
                    <tr>
                        <th>Pesquisar Corretores</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <table class="tabela">
                                <tbody>
                                    <tr>
                                        <td><input type="submit" value="Visualizar / Editar" name="VisualizarCorreto" class="botoes" /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
