...
<html>
    <head>
        ...
        <title>Pesquisar Negociações de Imóveis</title>
    ...
    <body>
        ...
        <form method="POST" action="VisualizarNegociacoes.jsp">
            <table class="tabela">
                <thead>
                    <tr>
                        <th>Pesquisar Negociações de Imóveis</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <table class="tabela">
                                <tbody>
                                    <tr>
                                        <td><input type="submit" value="Visualizar Negociações" name="VisualizarTransacoes" class="botoes" /></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
